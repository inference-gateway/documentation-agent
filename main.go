...
func main() {
	...
	logger.Info("registered skill", zap.String("skill", "resolve_library_id"), zap.String("description", "Resolves library by its id"))

	// Register get_library_docs skill
	getLibraryDocsSkill := skills.NewGetLibraryDocsSkill()
	toolBox.AddTool(getLibraryDocsSkill)
	logger.Info("registered skill", zap.String("skill", "get_library_docs"), zap.String("description", "Get the docs for the specific library"))
