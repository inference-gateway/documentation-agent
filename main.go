// Code generated by ADL CLI v0.10.2 on 2025-09-02 19:54:05. DO NOT EDIT.
...
func main() {
	...
	logger.Info("registered tool", zap.String("tool", "resolve_library_id"), zap.String("description", "Resolves library name to Context7-compatible library ID and returns matching libraries"))

	// Register get_library_docs tool
	get_library_docsTool := tools.NewGetLibraryDocsTool()
	toolBox.AddTool(get_library_docsTool)
	logger.Info("registered tool", zap.String("tool", "get_library_docs"), zap.String("description", "Fetches up-to-date documentation for a library using Context7-compatible library ID"))
