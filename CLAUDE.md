...
The codebase is generated using ADL CLI 0.20.8 and follows a strict generation pattern:
...
- **ADL Version**: Ensure ADL CLI 0.20.8 or compatible version for regeneration
