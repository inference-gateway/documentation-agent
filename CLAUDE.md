...
The codebase is generated using ADL CLI 0.19.14 and follows a strict generation pattern:
...
- **ADL Version**: Ensure ADL CLI 0.19.14 or compatible version for regeneration
